  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, seasonsSnapshot) {
        switch (seasonsSnapshot.connectionState) {
          ...
          case ConnectionState.done:
            if (seasonsSnapshot.hasError) {
              return Center(
                child: Text("Seasons Error: ${seasonsSnapshot.error}"),
              );
            }
            break;
          default:
        ...
        return FutureBuilder(
          future: matches.getMatches(seasonsSnapshot.data?.currentSeason),
